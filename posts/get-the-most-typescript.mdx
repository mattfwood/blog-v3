...
To get the most out of Typescript, you'll more than likely habe to use VS code, which has a ton of Typescript integrations built in (since they're both made by Microsoft).
